...
bool Screen::init()
{
	...
	{
		cout << "SDL initialization succeeded!" << endl << endl;
	}

	//Creation window Function
	...
	m_texture = SDL_CreateTexture(m_renderer, SDL_PIXELFORMAT_RGBA8888, SDL_TEXTUREACCESS_STATIC, SCREEN_WIDTH, SCREEN_HEIGHT);                                                             // Texture Creation
	...
	if (m_texture == NULL) {
		cout << "Could not creat texture." << endl;
